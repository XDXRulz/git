...
//								$('<a href="#" class="selecteee">aaa</a>'),
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										$('<a class="dp-nav-prev-year" href="#" title="' + $.dpText.TEXT_PREV_YEAR + '">' + $.dpText.ICON_PREV_YEAR + '</a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '">' + $.dpText.ICON_PREV_MONTH + '</a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
										$('<a class="dp-nav-next-year" href="#" title="' + $.dpText.TEXT_NEXT_YEAR + '">' + $.dpText.ICON_NEXT_YEAR + '</a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '">' + $.dpText.ICON_NEXT_MONTH + '</a>')
											.bind(
												'click',
												function()
												{
...
//					$('.selectee', this.context).focus();
	...
	$.dpText = {
        ...
        ICON_PREV_YEAR		:	'<img src=\'css/icons/left2.png\' alt=\'\'/>',//'&lt;&lt;',
        ICON_PREV_MONTH		:	'<img src=\'css/icons/left.png\' alt=\'\'/>',//'&lt;',
        ICON_NEXT_YEAR		:	'<img src=\'css/icons/right2.png\' alt=\'\'/>',//'&gt;&gt;',
        ICON_NEXT_MONTH		:	'<img src=\'css/icons/right.png\' alt=\'\'/>'//'&gt;'
    };
	// version
